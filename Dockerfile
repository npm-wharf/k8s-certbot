...
RUN ARCH= && alpineArch="$(apk --print-arch)" && \
    case "${alpineArch##*-}" in x86_64) ARCH='x64' CHECKSUM="043f9e1c412a391f42a9667373b851590a9a77c08cf6fde6828a3cdb3fb8f316" ;; *) ;; esac
...
RUN apk add --no-cache git make g++ nano
RUN mkdir -p /app/src
COPY ./src /app/src
COPY ./bin /app/bin
